...
NEW_SYSTEM_DATE = "2026-03-11T12:00:00Z"
...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v6.0.2 started: Mar 11, 2026 21:00 KST | v6.0.2 (disable trailing, signal filter, ATR floor)")
