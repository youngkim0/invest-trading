...
NEW_SYSTEM_DATE = "2026-03-10T05:17:00Z"
...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v6.0.1 started: Mar 10, 2026 14:17 KST | v6.0.1 (fixed R:R + OI filtering)")
