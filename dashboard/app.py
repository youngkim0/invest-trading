...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v8.3 started: Apr 26, 2026 | v8.3 (tighter SL/TP + trailing stops + regime detection, 5 strategies, 6 coins)")
