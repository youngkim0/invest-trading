...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v6.8 started: Mar 30, 2026 | v6.8 (4 long + 4 short strategies, 6 coins, smart money + adaptive sizing)")
