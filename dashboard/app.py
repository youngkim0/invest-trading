...
NEW_SYSTEM_DATE = "2026-04-06T04:50:00Z"  # v7.0.1 deploy: portfolio risk + Kelly + AI rebalance
...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v7.0.1 started: Apr 6, 2026 | v7.0.1 (Kelly sizing, AI rebalance 12h, portfolio risk controls, 6 coins)")
