...
def main():
    ...
    st.caption(f"Last updated: {kst_now.strftime('%Y-%m-%d %H:%M:%S KST')} | v6.9.3 started: Apr 3, 2026 | v6.9.3 (4h uptrend filter for longs, 3 long + 4 short strategies, 6 coins, smart money + adaptive sizing)")
